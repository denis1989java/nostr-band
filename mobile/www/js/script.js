!function() {
    ...
    function t(t, e) {
        if (/^localhost$|^127(\.[0-9]+){0,2}\.[0-9]+$|^\[::1?\]$/.test(l.hostname) || "file:" === l.protocol)
    ...
    function r(t) {
        ...
        "auxclick" === t.type && t.button !== s || ((e = function(t) {
            for (; t && (void 0 === t.tagName || !(e = t) || !e.tagName || "a" !== e.tagName.toLowerCase() || !t.href); )
                t = t.parentNode;
            var e;
            return t
        }(t.target)) && e.href && e.href.split("?")[0],
        (i = e) && i.href && i.host && i.host !== l.host && (i = t,
            t = {
            ...
            !function(t, e) {
                if (!t.defaultPrevented)
                    return e = !e.target || e.target.match(/^_(self|parent|top)$/i),
                        t = !(t.ctrlKey || t.metaKey || t.shiftKey) && "click" === t.type,
                    e && t
            }(i, n) ? (a = {
                props: t.props
            },
                plausible(t.name, a)) : (a = {
                props: t.props,
                callback: o
            },
                plausible(t.name, a),
